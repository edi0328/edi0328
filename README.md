...
- [RISCV_Pipeline](https://github.com/edi0328/RISCV_Pipeline) — RISC-V pipelined processor project with hazard detection in VHDL
- [TuringPoker](https://github.com/edi0328/TuringPoker) — Python project exploring game logic and programming fundamentals
- [zero2prod](https://github.com/edi0328/zero2prod) — Rust backend development practice

Thanks for visiting — feel free to explore my projects!## Hi there 👋

<!--
**edi0328/edi0328** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
